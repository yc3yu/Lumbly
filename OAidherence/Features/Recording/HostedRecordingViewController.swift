...
struct HostedRecordingViewController: UIViewControllerRepresentable {
    var viewControllerLink: ViewControllerLink
    ...
    func updateUIViewController(_ uiViewController: UIViewController, context: Context) {
        context.coordinator.viewController = uiViewController as? any ViewControllerLinkable
    ...
    class Coordinator {
        ...
        var viewController: ViewControllerLinkable?
