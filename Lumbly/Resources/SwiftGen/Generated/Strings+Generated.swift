...
internal enum L10n {
  ...
  internal enum ExerciseRatingTileView {
    /// Disliked it
    internal static let dislikedIt = L10n.tr("Localizable", "ExerciseRatingTileView.dislikedIt", fallback: "Disliked it")
    /// Liked it
    internal static let likedIt = L10n.tr("Localizable", "ExerciseRatingTileView.likedIt", fallback: "Liked it")
    /// Neutral
  ...
  internal enum ExerciseSetView {
    ...
    /// Physiotherapy
    internal static let physiotherapyIcon = L10n.tr("Localizable", "ExerciseSetView.physiotherapyIcon", fallback: "Physiotherapy")
    /// Start Exercise Set
    internal static let startExerciseSet = L10n.tr("Localizable", "ExerciseSetView.startExerciseSet", fallback: "Start Exercise Set")
  }
  internal enum ExerciseTipView {
    /// TIP #
